            ...
            >
                ...
                <View style={styles.roleContainer}>
                    ...
                    <View style={styles.roleButtons}>
                        <TouchableOpacity
                            style={[styles.roleButton, selectedRole === 'candidate' && styles.roleButtonActive]}
                        ...
                        >
                            ...
                            />
                            <Text style={[styles.roleButtonText, selectedRole === 'candidate' && styles.roleButtonTextActive]}>
                                Người tìm việc
                            </Text>
                        </TouchableOpacity>
                        ...
                        >
                            ...
                            />
                            <Text style={[styles.roleButtonText, selectedRole === 'employer' && styles.roleButtonTextActive]}>
                                Nhà tuyển dụng
                            </Text>
                        </TouchableOpacity>
                    </View>
