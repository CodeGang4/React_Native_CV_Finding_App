...
export default function CandidateHomeScreen({ navigation }) {
    ...
    const quickActions = [
        { title: 'Tìm việc làm', icon: 'search', screen: 'JobSearch', color: '#00b14f' },
        { title: 'Đơn ứng tuyển', icon: 'description', screen: 'Applications', color: '#2196F3' },
        { title: 'Hồ sơ của tôi', icon: 'person', screen: 'Profile', color: '#FF9800' },
    ];
            ...
            <View style={styles.quickActions}>
                ...
                <View style={styles.actionGrid}>
                    {quickActions.map((action, index) => (
                        ...
                        >
                            <MaterialIcons name={action.icon} size={40} color={action.color} />
